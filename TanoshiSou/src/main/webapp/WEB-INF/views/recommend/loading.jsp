...
<script type="text/javascript">
	...
	function getResult() {
		$("#form").attr('action',
				'${pageContext.request.contextPath}/recommend/result');
		$("#form").submit();
	}
	function move() {
			...
			<div class="container">
				<div class="row">
					<div
						...
						<h1 class="headerTitle" style="margin: 30px;">楽し荘</h1>
						<img
							src="${pageContext.request.contextPath}/images/tanoshisou-logo.png"
							width="250" height="250">
						<div>
							楽し荘는 보다 편리한 쉐어하우스 이용을 위한 커뮤니티 입니다.<br> 楽し荘에서 즐거운 추억을 만들어보세요.
						</div>
						<br>
						<div id="myProgress">
							<div id="myBar">10%</div>

...
<script>
	...
	function valueSetting() {
		var board_content = new Date("${getPhoto.board_content}");
		document.getElementById('board_content').valueAsDate = board_content;
		var board_title = '${getPhoto.board_title }';
		document.getElementById('board_title').value = board_title;
		document.getElementById('board_title').focus();
		document.getElementById('board_title').select();
	}
</script>
</head>
<body onload="valueSetting();">
	<!-- 헤더 연습 -->
